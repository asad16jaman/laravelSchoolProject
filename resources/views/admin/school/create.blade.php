                                    ...
                                    <div class="col-lg-6">
                                        <div class="">
                                            ...
                                            <select id="regionSelect" onchange="updateDistricts()" name="region" class="form-select border px-3 @error('region') is-invalid @enderror">
                                                ...
                                                <option value="Ahafo" @selected(old('region')  == 'Ahafo')>Ahafo</option>
                                                <option value="Ashanti" @selected(old('region')  == 'Ashanti')>Ashanti</option>
                                                <option value="Bono" @selected(old('region')  == 'Bono')>Bono</option>
                                                <option value="Bono East" @selected(old('region')  == 'Bono East')>Bono East</option>
                                                ...
                                                <option value="North East" @selected(old('region')  == 'North East')>North East</option>
                                                <option value="Northern" @selected(old('region')  == 'Northern')>Northern</option>
                                                <option value="Oti" @selected(old('region')  == 'Oti')>Oti</option>
                                                <option value="Savannah" @selected(old('region')  == 'Savannah')>Savannah</option>
                                                ...
                                                <option value="Western North" @selected(old('region')  == 'Western North')>Western North</option>
                                            </select>
                                            @error('region') 
                                                <p class="text-danger" style="font-size:12px">{{$message}}</p>
                                             @enderror
                                    ...
                                    <div class="col-lg-6">
                                        <div class="">
                                            ...
                                            @if(Auth::user()->role_id == 1)
                                                <select name="user_id" disabled class="form-select border px-3 "  aria-label="Default select example">
