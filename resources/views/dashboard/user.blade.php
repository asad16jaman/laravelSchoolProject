                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">In day</p>
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">In week</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        $230,220
                                    </h5>
                                    {{-- <span class="text-sm text-end text-success font-weight-bolder mt-auto mb-0">+55%
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">In month</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        $230,220
                                    </h5>
                                    {{-- <span class="text-sm text-end text-success font-weight-bolder mt-auto mb-0">+55%
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">In year</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        $230,220
                                    </h5>
                                    {{-- <span class="text-sm text-end text-success font-weight-bolder mt-auto mb-0">+55%
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">Posts Drafted</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        60
                                    </h5> 
                                </div> 
                ...
                <div class="col-sm-3 mt-sm-0 mt-4">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">Total Published Posts</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        60
                                    </h5> 
                                </div> 
                ...
                <div class="col-sm-3 mt-sm-0 mt-4">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">Total Posts</p>
                                    <h5 class="font-weight-bolder mb-0">
                                      120
                                    </h5> 
                                </div> 
                ...
                <div class="col-sm-3 mt-sm-0 mt-4">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">Images in medial library</p>
                                    <h5 class="font-weight-bolder mb-0">
                                       1200
                                    </h5> 
                                </div> 
                ...
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">Purchased Bundles</p>
                                    <h5 class="font-weight-bolder mb-0">
                                       10
                                    </h5> 
                                </div> 
                ...
                <div class="col-sm-3 mt-sm-0 mt-4">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">Bundles In Medial Collection</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        10
                                     </h5> 
                                </div>
                ...
                <div class="col-sm-3 mt-sm-0 mt-4">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">Available Bundles</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        0
                                    </h5> 
                                </div> 
                ...
                <div class="col-sm-3 mt-sm-0 mt-4">
                    <div class="card">
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col-7 text-start">
                                    <p class="text-sm mb-1 text-capitalize font-weight-bold">Available Bundles In platform</p>
                                    <h5 class="font-weight-bolder mb-0">
                                        100
                                    </h5> 
                                </div> 
                        ...
                        <div class="card-header pb-0 p-3">
                            ...
                            <div class="d-flex align-items-center">
                                <span class="badge badge-md badge-dot me-4">
                                    <i class="bg-primary"></i>
                                    <span class="text-dark text-xs">Published</span>
                                </span>
                                <span class="badge badge-md badge-dot me-4">
                                    <i class="bg-dark"></i>
                                    <span class="text-dark text-xs">Draft</span>
                                </span>
                            </div>
                        </div>
